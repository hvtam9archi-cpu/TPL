...
namespace TPL.Infrastructure.Localization
{
	/// <summary>
	/// Dịch vụ đa ngôn ngữ — implement ILocalizationService.
	/// Giữ nguyên static access L10n.T() cho backward compatibility.
	/// </summary>
	public class LocalizationService : ILocalizationService
	{
		// Static singleton for backward compat (L10n.T() usage in Views)
		private static LocalizationService _instance;
		public static LocalizationService Instance => _instance;

		private Language _lang = Language.Vietnamese;
		...
		public void SetLanguage(Language lang) => _lang = lang;
		public static void Set(Language lang) { if (_instance != null) _instance._lang = lang; }
		public Language CurrentLanguage => _lang;
		public static Language Current => _instance?._lang ?? Language.Vietnamese;

		public string Translate(string key) => T(key);

		public static string T(string key)
		{
			var inst = _instance ?? new LocalizationService();
			Language lang = inst._lang;
			Dictionary<string, string> d = lang switch
			{
